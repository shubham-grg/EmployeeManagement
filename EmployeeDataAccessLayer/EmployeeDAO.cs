...
namespace EmployeeDataAccessLayer
{
    public class EmployeeDAO : IEmployeeDAO
    {
        ...
        public EmployeeDAO()
        {
            ...
            client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", APIConstant.AuthorizationToken);
            client.BaseAddress = new Uri(APIConstant.Url);
